...
class PSWController:
    ...
    def set_vi(self, v, i):
        self.target_v = v
        self.target_i = i
        self._write(f"APPLy {v:.4f},{i:.4f}")

    def set_voltage(self, v):
        # Giữ cho tương thích, gọi set_vi với dòng hiện tại
        self.set_vi(v, self.target_i)

    def set_current(self, i):
        # Giữ cho tương thích, gọi set_vi với áp hiện tại
        self.set_vi(self.target_v, i)
